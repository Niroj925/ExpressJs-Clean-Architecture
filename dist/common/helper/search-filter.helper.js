...
exports.searchByCharactersAndPagingate = exports.searchByCharacters = void 0;
const searchInObject = (obj, path = '', searchLower) => {
    ...
    return Object.entries(obj).some(([key, value]) => {
        ...
        if (Array.isArray(value)) {
            return value.some((item) => {
                ...
                return item === null || item === void 0 ? void 0 : item.toString().toLowerCase().includes(searchLower);
            });
        }
...
const searchByCharacters = (items, searchString) => {
...
exports.searchByCharacters = searchByCharacters;
const searchByCharactersAndPagingate = (items, searchString, page, limit) => {
...
exports.searchByCharactersAndPagingate = searchByCharactersAndPagingate;
